...
from config import CONFIG, get_textures_path, get_textures_paths
    ...
    def _build_index(self):
        ...
        for scan_dir in scan_paths:
            ...
            for root, dirs, files in os.walk(scan_dir):
                for file in files:
                    if file.lower().endswith(('.png', '.tga', '.j2c', '.jp2', '.jpg', '.jpeg', '.bmp')):
...
def draw_9_slice(painter, pixmap, rect, border_left=4, border_top=4, border_right=4, border_bottom=4):
    ...
    # SAFEGUARD: If the texture is too small to be 9-sliced (e.g., 1x1 or 4x4 fill textures),
    ...
    dst_edges = [
        ...
        # --- CRITICAL FIX: Corrected to exactly 4 arguments (left, top, width, height) ---
